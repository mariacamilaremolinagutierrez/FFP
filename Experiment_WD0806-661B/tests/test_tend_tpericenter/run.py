...
def permute(m_bp):
    ...
    total_permutations = n_as_bp*n_bs_ffp*n_incs_bp*n_lans_bp*n_phis_bp*n_ns
            ...
            for inc_bp in incs_bp:
                ...
                for lan_bp in lans_bp:
                    ...
                    for j in range(n_phis_bp):
                        ...
                        for n in number_times_pericenter:
                            ...
                            if (i>num_runs):
                                ...
                                #Filename
                                t_end, max_energy_change, is_stable, e_star_ffp, e_star_bp, sma_star_ffp, sma_star_bp, inc_star_ffp, inc_star_bp, lan_star_ffp, lan_star_bp, ap_star_ffp, ap_star_bp = ffp.run_capture(n,
                                                                                                                                                                                                                    m0_p=m0,
                                                                                                                                                                                                                    m_ffp_p=m_ffp,
                                                                                                                                                                                                                    e_bp_p=e_bp,
                                                                                                                                                                                                                    m_bp_p=m_bp,
